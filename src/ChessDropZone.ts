...
type ChessDropZoneEventListener<Data extends ChessDropZoneEvent = any> = (event: Data) => void
...
export default class ChessDropZone {
  ...
  addEventListener (type: 'drop', listener: ChessDropZoneEventListener<ChessDragAndDropData>): void;
  addEventListener (type: ChessDropZoneEventType, listener: ChessDropZoneEventListener) {
    this.#listeners.addAndGet(type, listener);
  }

  removeEventListener (type: ChessDropZoneEventType, listener: ChessDropZoneEventListener) {
